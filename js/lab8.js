...
User3.prototype.sort = function () {
    this.students.forEach(
        student => console.log(this.firstName + ': ' + student)
    );
}
let user3_1 = new User("Jack3", "Lack", [66, 99, 86]);
let user3_2 = new User("Dove3", "Lovy", [50, 80, 40]);
let userArr = [user3_1, user3_2];
